...
public class Login extends javax.swing.JFrame {
    ...
    public void conector(){
        ...
        JOptionPane.showMessageDialog(null,"en línea");
    ...
    public void entrada(){
        try(Connection connection = DriverManager.getConnection(url, user,pass)){
            ...
            ps=connection.prepareStatement("SELECT * FROM login.users WHERE nombre='"+name+"'"+"AND contraseña='"+contraseña+"'");
    ...
    private void initComponents() {
        ...
        Ingreso.setFont(new java.awt.Font("Lucida Console", 0, 12)); // NOI18N
        ...
        Verificador.setText("Verificar Conexión");
        Verificador.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Verificador.setMaximumSize(new java.awt.Dimension(97, 23));
